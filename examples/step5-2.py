...
shapes.append(
    BezierCurveShape(
        control_points=[(0, 50, 0), (50, 0, 25)],  # Control points for the curve
        bezier_segments=25,  # Number of segments to divide the curve
        position=(50, 50, 25),  # End point of the curve
        size=(10, 10, 10),
        shape_type="rounded_cube",
        rounded_cube_radius=(3, 3, 3),
    )
